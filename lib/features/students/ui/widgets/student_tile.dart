...
class StudentTile extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final semanticLabel = t.students.tile.semanticLabel(
      fullName: student.fullName,
      email: student.parentContactEmail ?? t.students.tile.noEmail,
    );
              ...
              child: Row(
                children: [
                  ...
                  Hero(
                    ...
                    child: Semantics(
                      label: t.students.tile.avatarSemanticLabel(
                        fullName: student.fullName,
                      ),
                      image: true,
                  ...
                  ref.watch(userRolePod) == UserRole.student
                      ...
                      : Semantics(
                          label: t.students.tile.actionsSemanticLabel(
                            fullName: student.fullName,
                          ),
                          button: true,
                          hint: t.students.tile.actionsHint,
                          child: PopupMenuButton<String>(
                            ...
                            itemBuilder: (context) => [
                              PopupMenuItem(
                                value: 'edit',
                                child: Semantics(
                                  label: t.students.tile.editSemanticLabel,
                                  button: true,
                                  child: Row(
                                    children: [
                                      Container(
                              ...
                              PopupMenuItem(
                                value: 'delete',
                                child: Semantics(
                                  label: t.students.tile.deleteSemanticLabel,
                                  button: true,
                                  child: Row(
                                    children: [
                                      Container(
